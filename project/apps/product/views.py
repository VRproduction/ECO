...
from apps.account.utils.login_helper import AuthView, IsNotAuthView
from apps.seo.models import AboutPageSeo, BlogPageSeo, ShopPageSeo, ContactPageSeo, CompaniesPageSeo
from .models import FAQ, BasketItem, Blog, ContactPage, CouponUsage, Favorite, Order, OrderItem, ProductCategory, Product, Company, Partner, Coupon
...
def start_task(request):
    task = remove_expired_discounts.delay(12)  # 10 saniyelik bir task başlatır
