(function ($) {
    ...
    $(window).on("load", function () {
        $("#preloader-active").delay(20).fadeOut("slow");
        $("body").delay(20).css({
            overflow: "visible"
        });
