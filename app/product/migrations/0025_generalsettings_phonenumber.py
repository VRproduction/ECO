...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('product', '0024_product_description_product_is_main_page_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('number', models.CharField(blank=True, max_length=200, null=True, verbose_name='Youtube')),
                ('setting', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='settings', to='product.generalsettings')),
            ],
            options={
                'verbose_name': 'Nömrə',
